...
- Updated version info during build (v8.0 for WP 5.7) (Thomas Sjolshagen)
- Updated version info during build (v8.0 for WP 5.7) (Thomas Sjolshagen)
- BUG FIX: Didn't have coverage set up correctly (Thomas Sjolshagen)
- BUG FIX: Errors generating changelog.md (Thomas Sjolshagen)
- Updated version info during build (v8.0 for WP 5.7) (Thomas Sjolshagen)
- Updated version info during build (v8.0 for WP 5.7) (Thomas Sjolshagen)
- Updated version info during build (v for WP 5.7) (Thomas Sjolshagen)
...
- BUG FIX: Wrong path to utilities classes after renaming directory from class to src BUG FIX: Not checking if Utilities module is present (Thomas Sjolshagen)
...
- ENH: Added skeleton (tempate) files for documentation, etc. (Thomas Sjolshagen)
- Updated version info during build (v7.6 for WP 5.6.1) (Thomas Sjolshagen)
- Updated version info during build (v7.6 for WP 5.6.1) (Thomas Sjolshagen)
- Updated version info during build (v7.6 for WP 5.6.1) (Thomas Sjolshagen)
- Updated version info during build (v7.6 for WP 5.6.1) (Thomas Sjolshagen)
...
- BUG FIX: Refactored to use Class::plugin_slug for translation strings BUG FIX: Refactored for silly max-char (self enforced) limits BUG FIX: Removed stale commented code (Thomas Sjolshagen)
- BUG FIX: Refactored to use Class::plugin_slug for translation strings BUG FIX: Refactored for silly max-char (self enforced) limits (Thomas Sjolshagen)
...
- Update change logs & version number (v7.5) (Thomas Sjolshagen)
- BUG FIX: Didn't automatically search for levels only when selected level is changed (Thomas Sjolshagen)
- Merge branch 'main' of github.com:eighty20results/e20r-members-list into main (Thomas Sjolshagen)
- Bug fix/typed search reset (#34) (Thomas Sjølshagen)
- Bug fix/typed search reset (#33) (Thomas Sjølshagen)
- Merge commit 'e5755e7a1af2ae4feef17c2d3011c196c4b875d2' into main (Thomas Sjolshagen)
- Merge pull request #97 from eighty20results/BUG_FIX/Removing_update_module (Thomas Sjølshagen)
- BUG FIX: Problems updating update module call-out in other plugins embedding 00-e20r-utilities Update change logs & version (v1.0.8) (Thomas Sjolshagen)
## [7.6] - 2021-02-22
