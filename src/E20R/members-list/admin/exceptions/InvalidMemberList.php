 ...
 *
 * @package E20R\Members_List\Admin\Exceptions\DBQueryError
 */
...
if ( ! class_exists( 'E20R\Members_List\Admin\Exceptions\InvalidMemberList' ) ) {

	/**
	 * Raised when a developer attempts to add a non-array as the members_to_update array
	 */
	class InvalidMemberList extends Exception {
